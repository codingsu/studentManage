...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="index.html">
			<img src="<c:url value="/metronic/assets/admin/layout/img/logo.png"/>" alt="logo" class="logo-default"/>
			</a>
		...
		<div class="top-menu">
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown dropdown-user">
					...
					<img alt="" class="img-circle hide1" src="<c:url value="/metronic/assets/admin/layout/img/avatar3_small.jpg"/>"/>
	...
	<div class="page-sidebar-wrapper">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu " data-auto-scroll="true"
					...
					<li class="start active open"><c:if test="${sessionScope.ROLE== '1'}"><a href="<c:url value='/personal-${sessionScope.ADMIN_CONTEXT}'/>"></c:if>
				...
				<div class="col-md-12">
					...
					<div class="tabbable tabbable-custom tabbable-full-width">
						<ul class="nav nav-tabs">
							<li class="active">
								<a href="#tab_1_3" data-toggle="tab">概览 </a>
							</li>
						</ul>
								...
								<div class="row profile-account">
									<div class="col-md-3">
										<ul class="ver-inline-menu tabbable margin-bottom-10">
											<li>
												<img src="<c:url value="${admin.imagePath }"/>" class="img-responsive" alt=""/>
									...
									<div class="col-md-9">
										<div class="tab-content">
											<div id="tab_1-1" class="tab-pane active">
												<form role="form" id="changeAdminInfForm" action="#">
													
													<div class="form-group">
														<label class="control-label">ID</label>
														<input type="text" id="adminId" class="form-control" value="${admin.adminId}" disabled />
													</div>
													<div class="form-group">
														<label class="control-label">联系电话</label>
														<input type="text" id="phone" class="form-control" disabled value="${admin.phone}"/>
													</div>
													<div class="form-group">
														<label class="control-label">邮箱</label>
														<input type="text" id="email" class="form-control" disabled value="${admin.mail}"/>
													</div>
													
													
													<div class="margiv-top-10">
														<button id="edit" type="button" class="btn green" style="block" onclick="doclick();">编辑</button>
														<button id="infoCommit" type="button" class="btn green" onclick="checkAdminProfileForm();" disabled="disabled" >提交</button>
														<button id="infoCancel" type="button" class="btn default" disabled="disabled" onclick="reload();">取消</button>
													</div>
												</form>
											</div>
													...
													<div class="form-group">
														<div class="fileinput fileinput-new" data-provides="fileinput">
															<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
																<img id="imagepath" src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image" alt=""/>
															</div>
											...
											<div id="tab_3-3" class="tab-pane">
												<form id="changePwdForm" action="#" onsubmit="return checkPassword();">
													<div id="nowpwd" class="form-group" style="visibility: visible;">
														<label class="control-label">当前密码</label>
														<input type="password" id="pwd" class="form-control"/>
													</div>
													<div class="form-group">
														<label class="control-label">新密码</label>
														<input type="password" id="onepwd" class="form-control"/>
													</div>
													<div class="form-group">
														<label class="control-label">再次输入新密码</label>
														<input type="password" id="twopwd" class="form-control"/>
													</div>
													<div class="margin-top-10">
														<button type="button" class="btn green" onclick="changePwd()">提交</button>
...
<!-- END CORE PLUGINS -->
<script src="<c:url value="js/admin_profile_check.js"/>" type="text/javascript"></script>
