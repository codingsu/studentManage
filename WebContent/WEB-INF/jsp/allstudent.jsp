...
<link rel="stylesheet" type="text/css"
	href="<c:url value="/metronic/assets/global/plugins/select2/select2.css"/>" />
<link rel="stylesheet" type="text/css"
	href="<c:url value="/metronic/assets/global/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.css"/>" />
...
<body class="page-header-fixed page-quick-sidebar-over-content ">
		...
		<div class="page-sidebar-wrapper">
			...
			<div class="page-sidebar navbar-collapse collapse">
				...
				<ul class="page-sidebar-menu " data-auto-scroll="true"
					...
					<li  class="start active open"><a href="<c:url value='/allStudent'/>" id="allstudent"> <i
							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-hover table-bordered"
									...
									<tbody>
										...
										<c:forEach items="${allStudent}" var="lu"
											varStatus="ul">
											<tr>
												<td>${lu.name}</td>
												...
												<td>${lu.phone }</td>
												<td>${lu.mail }</td>
												<td><a href="/StudentInformationSystem/personal-${lu.studentID}">详情</a></td>
												<c:if test="${sessionScope.ROLE== '1'}">
	...
	<div class="page-footer">
		<div class="page-footer-inner">2016 &copy; 软件安全小组.</div>
...
<![endif]-->
	<script src="<c:url value="/js/jquery-1.12.1.min.js"/>"
	...
	<script type="text/javascript"
		src="<c:url value="/metronic/assets/global/plugins/select2/select2.min.js"/>"></script>
	<script type="text/javascript"
		src="<c:url value="/metronic/assets/global/plugins/datatables/media/js/jquery.dataTables.min.js"/>"></script>
	<script type="text/javascript"
		src="<c:url value="/metronic/assets/global/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.js"/>"></script>
	...
	<script
		...
		type="text/javascript"></script>
	<script
		src="<c:url value="/metronic/assets/admin/pages/scripts/table-editable.js"/>"></script>
	<script>
